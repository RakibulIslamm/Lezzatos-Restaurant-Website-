            ...
            <div className='px-[100px] xs:px-5 sm:px-10 max-w-[1920px] mx-auto'>
                <div className='flex justify-between'>
                    <div className='w-8/12 space-y-5'>
                        <div className='flex items-end justify-between gap-5 overflow-hidden'>
                            ...
                            <img className='h-[275px] w-7/12 object-cover object-center' src={img1} style={{
                                clipPath: 'polygon(24.4% 0%, 77.3% 0%, 100% 37.1%, 100% 100%, 76.1% 100%, 0% 100%, 0% 80%, 0% 0%)'
                            }} alt="" />
                        </div>
                        <div>
                    ...
                    <div className='w-4/12'>
                        <div className='px-10 py-12 bg-white relative z-20 space-y-10 -ml-12 mt-16 shadow-2xl shadow-black'>
                            <h2 className='text-4xl font-dancing-script font-semibold'>Main Course</h2>
                            <SingleMenu2 />
                            <SingleMenu2 />
                            <SingleMenu2 />
                            <SingleMenu2 />
