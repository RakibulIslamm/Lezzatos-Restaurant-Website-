        ...
        `}
            ...
            <div>
                <div className='relative order-parent'>
                    <img className='relative z-0 min-h-[250px] w-full object-cover' src={food} style={{
                    ...
                    <div className='absolute w-full h-[250px] bg-[#F8BE69] bg-opacity-50 z-10 top-0 flex justify-center items-center order-btn invisible' style={{
                        clipPath: 'polygon(0% 0%, 77.9% 0%, 100% 22.1%, 100% 84.7%, 100% 100%, 0% 100%, 0% 84.7%, 0% 15.3%)'
                    }}>
