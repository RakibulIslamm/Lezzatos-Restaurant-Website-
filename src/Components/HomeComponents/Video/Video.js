...
const Video = () => {
    ...
    return (
        <div className='py-20 bg-gray-400 bg-cover bg-top transition-all ease-in-out duration-300' style={{
            ...
            <div className='px-[100px] max-w-[1920px] h-[70vh] mx-auto flex justify-center items-center relative'>
                ...
                <button onClick={() => setPlayer(!player)} className={`absolute -top-16 right-40 ${player ? 'block' : 'hidden'}`}>
